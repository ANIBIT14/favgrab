    ...
    <>
      <main className="main">
        <section className="hero">
          <div className="hero-eyebrow">Favicon Extractor — v0.0.2</div>
      ...
      <section className="tools-promo">
        <div className="section-inner">
          <Link to="/convert" className="tool-promo-card">
            <div className="tool-promo-left">
              <div className="tool-promo-eyebrow">NEW TOOL</div>
              <h3 className="tool-promo-title">Image Converter</h3>
              <p className="tool-promo-desc">
                Convert between PNG, JPG, WebP, AVIF, HEIC, TIFF, BMP, and ICO — 100% in your browser. No uploads, works offline.
              </p>
              <span className="tool-promo-cta">Open converter →</span>
            </div>
            <div className="tool-promo-right" aria-hidden="true">
              <div className="tool-promo-chip">PNG</div>
              <div className="tool-promo-arrow">→</div>
              <div className="tool-promo-chip tool-promo-chip-accent">WEBP</div>
            </div>
          </Link>
        </div>
      </section>
